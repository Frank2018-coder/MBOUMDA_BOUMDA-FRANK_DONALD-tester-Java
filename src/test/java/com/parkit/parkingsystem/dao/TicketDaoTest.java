...
class TicketDaoTest {
    ...
    public void testUpdatTicket() {
        ...
        ticketToUpdate.setParkingSpot(null); //modification a apporter
   ...
   @Test
   public void testFailledUpdateTicket(){
        Ticket ticketToUpdate = new Ticket();
        ticketToUpdate.setInTime(new Date());
        ticketToUpdate.setParkingSpot(null);
        ticketToUpdate.setVehicleRegNumber(null);
        ticketToUpdate.setPrice(0);
        ticketToUpdate.setOutTime(null);

        assertFalse(ticketdao.updateTicket(ticketToUpdate));
   }
